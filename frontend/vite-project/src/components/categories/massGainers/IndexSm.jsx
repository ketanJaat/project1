    ...
    <div>
        ...
        <div className=' mt-2 relative '>{/*poster */}
            <div className='flex items-center w-full'>
                <img className='w-full -z-10 h-28' src='https://www.supplementsvilla.com/uploads/sliders/65c4d43fc691d.jpg'/>
            </div>
        </div>
        ...
        <div className='grid grid-cols-2 bg-gray-700 grid-flow-row gap-4'>
            {
                                filterData.length > 0 && 
                                filterData.map(
                                    (products) => {
