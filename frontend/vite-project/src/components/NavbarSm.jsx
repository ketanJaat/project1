...
const NavbarSm = () => {
  ...
  return (
    <div>
        <nav className='bg-yellow-500 flex place-content-between items-center px-5'>
            <button onClick={handleClick} className='mr-10'>
                <FaBars className='text-3xl'/>
            </button>
            <div className={`bg-green-400 overflow-y-scroll ${isBrowseClick ? 'visible' : 'invisible'} z-10 -ml-10 w-1/2 p-8  mt-[544px] h-screen fixed flex place-content-evenly flex-col`}>
                <div>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className={`bg-white ${isCategoryClick ? 'visible' : 'invisible'} z-20 -ml-3 w-2/5 p- -mt-[96px]  h-screen fixed flex  flex-col`}>
                        <div className='mt-2'>
                            <div className='flex place-content-between items-center'>
                                <img className='h-10' src={logo}/>
                        ...
                        <div className='bg-orange-500 -mt- h-[640px] flex flex-col place-content-evenly relative'>
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500 absolute ml-[69px] ${activeSection === 'protein' ? 'block' : 'hidden'}  w-3/5 `}>
                            ...
                            <div className='w-full  flex '>
                                ...
                                <div className={`bg-purple-500 absolute ml-[69px] -mt-[60px] group-visited:visible ${activeSection === 'mass' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[140px] group-visited:visible ${activeSection === 'weight loss' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[216px] group-visited:visible ${activeSection === 'essentials' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[270px] group-visited:visible ${activeSection === 'health & Wellness' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[375px] group-visited:visible ${activeSection === 'Muscle Pumping' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[450px] group-visited:visible ${activeSection === 'stacks' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
                            ...
                            <div className='w-full  flex'>
                                ...
                                <div className={`bg-purple-500  absolute ml-[69px] -mt-[500px] group-visited:visible ${activeSection === 'carbo' ? 'block' : 'hidden'}  w-3/5 `}>
                                    <div className='border-2 border-black p-2 py-6'>All weight loss</div>
                                    <div className='border-2 border-black p-2 py-6'>l carnitine</div>
                                    <div className='border-2 border-black p-2 py-6'>fat burner</div>
                                    <div className='border-2 border-black p-2 py-6'>cla</div>
