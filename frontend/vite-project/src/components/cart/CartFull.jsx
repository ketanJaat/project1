        ...
        <div className=''>
            ...
            <div className='bg-gray-400  flex'>
                <div className='w-full bg-green-400 relative'>
                    <div className='flex '>
                        <div className='w-1/2 bg-purple-900 flex place-content-center'>product</div>
                        <div className='w-1/4 bg-red-800 flex place-content-center'>quantity</div>
                        <div className='w-40 bg-blue-700 flex place-content-center'>price</div>
                        <div className='w-24 bg-black flex place-content-center'>brand</div>
                    </div>
